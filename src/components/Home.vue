<template>
	<div id="portfolio">
		<section id="home" class="section section-c-2">
			<div class="column">
				<div class="wrapper wrapper-text lead-wrapper">
					<div>
		...
		<section id="hello" class="section section-c-1">
			<div class="column">
		...
		<section id="what" class="section section-c-2">
			<div class="column">
				<div class="wrapper wrapper-text">
					<div>
